...
import {PreviewkioskPage} from "../previewkiosk/previewkiosk";

/**
 * Generated class for the CamerakioskPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-camerakiosk',
  templateUrl: 'camerakiosk.html',
})
export class CamerakioskPage {
  baseImagePath;
  employee_id;
  file_name_final : any;
  timer;
  ...
  openPreview(){
    ...
    nav.push(PreviewkioskPage, {email:this.email, file_name_final:this.file_name_final,imageBase:this.baseImagePath, employee_id:this.employee_id});
  }
